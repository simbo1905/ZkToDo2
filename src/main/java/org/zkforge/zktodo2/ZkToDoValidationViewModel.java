...
public class ZkToDoValidationViewModel  {
	...
	protected Reminder newReminder = new Reminder();
	
	public Reminder getNewReminder() {
		return newReminder;
	}
	
	public void setNewReminder(Reminder reminder) {
	...
	public void add() {
		if( this.newReminder.getId() == null ){
			this.reminderService.persist(this.newReminder);
